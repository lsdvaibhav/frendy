		...
		for (Scat of superCat){
			...
			SupCatHTML = `	
							<div class="panel panel-default">
								<div class="panel-heading" role="tab" id="${Scat}-Panel-heading">
									<h6 class="panel-title"> 
										<a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#${Scat}" aria-expanded="false" aria-controls="${Scat}"> ${Scat} </a> 
									</h6>
								</div>
								<div id="${Scat}" class="panel-collapse collapse" role="tabpanel" aria-labelledby="${Scat}">
									<div class="panel-body" id="${Scat}-body" >
									</div>
								</div>
							</div>
						`
			...
			document.getElementById(Scat+'-body').innerHTML = listcat;
